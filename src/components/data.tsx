...
const ListadeProjetos = [
  { id: '1',
    ...
    linkGithub: 'https://github.com/PedroLucas-Developer/CorteCerto' ,
    status: 'Online 🟢' },
  { id: '2',
    title: 'IEEE RAS',
    ...
    linkGithub: 'https://github.com/PedroLucas-Developer/Ras-IEEE' ,
    status: 'Offline 🔴' },
  { id: '3',
    title: 'FaxinaExpress',
    subtitle: 'Site de agendamento',
    ...
    linkGithub: 'https://github.com/PedroLucas-Developer/FaxinaExpress' ,
    status: 'Online 🟢' },
];
